...
# SITE FILTER
# =========================================================
st.markdown("## 🛰️ Monitoring Sites")
...
# MAP + SYSTEM SUMMARY
# =========================================================
st.markdown("## 🗺️ Live Monitoring Map")
...
# SITE SUMMARY TABLE
# =========================================================
st.markdown("## 🛰️ Monitoring Site Summary")

site_summary_df = get_overview_site_table()

if (
    not site_summary_df.empty
    and selected_sites
):
    site_summary_df = site_summary_df[
        site_summary_df["location_name"].isin(
            selected_sites
        )
    ]
...
# EXPORT SECTION
# =========================================================
st.markdown("## ⬇️ Export Monitoring Data")
...
render_alert_table(
    filtered_df,
    title="Recent Monitoring Alerts",
    show_title=False
)
...
st.markdown(
    ...
    🌍 Forest Monitoring Intelligence System  
